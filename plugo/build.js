...
/* ------------------------------------------------------------
 * CSS custom (ancien style.css maintenant intégré au build)
 * ----------------------------------------------------------*/

const CUSTOM_APP_CSS = `
/* === Custom App CSS (ex-style.css) === */
:root {
    --bg: #0f172a;
...
`;
    ...
    // Ajout du CSS custom (ex-style.css) à la fin
    css += '\n\n/* === App-level styles (ex-style.css) === */\n';
    css += CUSTOM_APP_CSS;
